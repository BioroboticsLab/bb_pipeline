# -*- coding: utf-8 -*-
#
# bb_pipeline documentation build configuration file, created by
...
htmlhelp_basename = 'bb_pipelinedoc'
...
latex_documents = [
    (master_doc, 'bb_pipeline.tex', u'bb_pipeline Documentation',
...
man_pages = [
    (master_doc, 'bb_pipeline', u'bb_pipeline Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bb_pipeline', u'bb_pipeline Documentation',
     author, 'bb_pipeline', 'One line description of project.',
     'Miscellaneous'),
]
...
def linkcode_resolve(domain, info):
    ...
    fn = relpath(fn, start=dirname(pipeline.__file__))
    p = subprocess.Popen(['git', 'rev-parse', 'HEAD'], stdout=subprocess.PIPE)
    git_rev, err = p.communicate()
    git_rev = git_rev.decode('utf-8').rstrip('\n')
    print(git_rev)
    print(fn)
    return "https://github.com/BioroboticsLab/bb_pipeline/blob/{}/pipeline/{}{}".format(
       git_rev, fn, linespec)
