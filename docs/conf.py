# -*- coding: utf-8 -*-
#
# deeppipeline documentation build configuration file, created by
...
htmlhelp_basename = 'deeppipelinedoc'
...
latex_documents = [
    (master_doc, 'deeppipeline.tex', u'deeppipeline Documentation',
...
man_pages = [
    (master_doc, 'deeppipeline', u'deeppipeline Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'deeppipeline', u'deeppipeline Documentation',
     author, 'deeppipeline', 'One line description of project.',
     'Miscellaneous'),
]
...
def linkcode_resolve(domain, info):
    ...
    print(git_rev)
    print(fn)
    return "https://github.com/BioroboticsLab/deeppipeline/blob/{}/pipeline/{}{}".format(
       git_rev, fn, linespec)
